...
<div id="employeeBody">    
    ...
    <ul>
        <li><a href="/customer-representatives">Show all Customer Representatives</a></li>
        <li><a href="">Record a reservation</a></li>
        <li><a href="">Add, Edit and Delete information for a customer</a></li>
        <li><a href="">Produce customer mailing lists</a></li>
