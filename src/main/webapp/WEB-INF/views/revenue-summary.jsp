        ...
        <div class="mask">
            <c:choose>
                <c:when test="${param.mode eq 'city'}">
                    The total revenue generated by ${city} was <fmt:formatNumber type="currency" currencySymbol="$">${result}</fmt:formatNumber>.
                </c:when>
                    ...
                    <table>
                        ...
                        <c:forEach items="${results}" var="flight">
                            <tr>
                                ...
                                <td><fmt:formatNumber currencySymbol="$" type="currency">${flight.fare}</fmt:formatNumber></td>
                            </tr>
                    ...
                    <table>
                        ...
                        <c:forEach items="${results}" var="reservation">
                            <tr>
                                ...
                                <td><fmt:formatNumber currencySymbol="$" type="currency">${reservation.totalFare}</fmt:formatNumber></td>
                            </tr>
                            <c:set var="total" value="${total + reservation.totalFare}" />
                        </c:forEach>
                        <tr>
                            <td colspan="3"><strong>TOTAL</strong></td>
                            <td><fmt:formatNumber currencySymbol="$" type="currency">${total}</fmt:formatNumber></td>
                        </tr>
                    </table>
                </c:when>
            </c:choose>
